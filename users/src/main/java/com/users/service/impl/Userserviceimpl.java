...
public class Userserviceimpl implements UserService {
    ...
    @Override
    public List<UserResponseDto> findUserByTime(Date startDate, Date endDate,Long id) {
        List<Users> listOfCustomer = userRepo.findByCreatedDateBetweenAndId(startDate, endDate,id);
        return listOfCustomer.stream().map(list -> modelMapper.map(list, UserResponseDto.class)).toList();
    }
